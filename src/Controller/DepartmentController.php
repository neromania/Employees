...
class DepartmentController extends AbstractController
{
    ...
    #[Route('/{deptNo}', name: 'app_department_show', methods: ['GET'])]
    ...
    #[Route('/{deptNo}/edit', name: 'app_department_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{deptNo}', name: 'app_department_delete', methods: ['POST'])]
    public function delete(Request $request, Department $department, DepartmentRepository $departmentRepository): Response
    {
        if ($this->isCsrfTokenValid('delete'.$department->getDeptNo(), $request->request->get('_token'))) {
